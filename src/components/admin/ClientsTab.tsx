...
export function ClientsTab() {
  ...
  const getPlaceholderClients = () => [
    { id: 'placeholder-1', company_name: '', users: { name: '' }, authorizations: [], created_at: '', user_id: '', link_token: '' },
    { id: 'placeholder-2', company_name: '', users: { name: '' }, authorizations: [], created_at: '', user_id: '', link_token: '' },
    { id: 'placeholder-3', company_name: '', users: { name: '' }, authorizations: [], created_at: '', user_id: '', link_token: '' },
    { id: 'placeholder-4', company_name: '', users: { name: '' }, authorizations: [], created_at: '', user_id: '', link_token: '' },
    { id: 'placeholder-5', company_name: '', users: { name: '' }, authorizations: [], created_at: '', user_id: '', link_token: '' },
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
        <div className="grid grid-cols-12 gap-6 px-6 py-4 text-sm font-medium text-gray-500 border-b border-gray-100">
          ...
          <div className="col-span-3">Platform Status</div>
