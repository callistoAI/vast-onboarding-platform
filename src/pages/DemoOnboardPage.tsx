                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                  {Object.entries(platformConfigs).map(([platform, config]) => (
                    <div key={platform} className="text-center group">
                      <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg group-hover:scale-105 transition-transform duration-200`} style={{ background: `linear-gradient(135deg, ${config.color}, ${config.color}DD)` }}>
              ...
              {!showPermissions ? (
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-10">
                  <div className="text-center mb-10">
                    <div className={`w-24 h-24 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg`} style={{ background: `linear-gradient(135deg, ${currentConfig.color}, ${currentConfig.color}DD)` }}>
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-10">
                  <div className="text-center mb-10">
                    <div className={`w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg`} style={{ background: `linear-gradient(135deg, ${currentConfig.color}, ${currentConfig.color}DD)` }}>
                        ...
                        <div className="relative">
                          ...
                          <div className={`w-7 h-7 rounded-lg border-2 flex items-center justify-center transition-all duration-200 ${
                            (platformPermissions[currentPlatform]?.[permission] || false)
                              ? `border-${currentConfig.color} shadow-sm`
